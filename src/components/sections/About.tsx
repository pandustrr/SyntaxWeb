                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 pt-12 border-t border-black/5">
                            <div className="group">
                                <h4 className="text-black font-black uppercase tracking-[0.4em] text-[10px] mb-3 group-hover:text-[#22D3EE] transition-colors">{t.about.intelligent.title}</h4>
                                <p className="text-slate-500 text-sm font-medium">{t.about.intelligent.desc}</p>
                            </div>
                            <div className="group">
                                <h4 className="text-black font-black uppercase tracking-[0.4em] text-[10px] mb-3 group-hover:text-[#22D3EE] transition-colors">{t.about.evolution.title}</h4>
                                <p className="text-slate-500 text-sm font-medium">{t.about.evolution.desc}</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#FAFAFA] to-transparent z-10 pointer-events-none" />
                        
                        <div className="absolute top-0 right-0 p-8 z-10 pointer-events-none opacity-20 hidden md:block">
                            <span className="text-[10px] font-black text-black uppercase tracking-[0.5em] font-['Teko'] group-hover:text-[#22D3EE] transition-colors">TEAM_CORE_V4</span>
                        </div>
                    </motion.div>
                </div>
            </div>
